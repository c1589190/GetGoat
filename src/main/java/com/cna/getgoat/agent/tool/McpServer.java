 ...
 *
 * Usage:
 *   java -cp target/classes:$(mvn dependency:build-classpath -q -DincludeScope=runtime) com.cna.getgoat.agent.tool.McpServer
 *
 * Register in Claude Code settings.json:
 *   { "mcpServers": { "getgoat": { "command": "java", "args": ["-cp", "...", "com.cna.getgoat.agent.tool.McpServer"] } } }
 */
public class McpServer {
    ...
    private final com.cna.getgoat.map.campaigns.NodesManager branchManager;
    private final ToolRegistry registry;

    public McpServer() {
        this.mapManager = new MapManager();
        this.unitsManager = new UnitsManager();
        this.branchManager = new com.cna.getgoat.map.campaigns.NodesManager(unitsManager);
