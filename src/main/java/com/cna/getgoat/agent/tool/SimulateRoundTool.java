...
import com.cna.getgoat.agent.sim.SimulationResult;
...
public class SimulateRoundTool implements ToolUnit {
    ...
    public SimulateRoundTool(MapManager mm, UnitsManager um, NodesManager bm) {
        this.mapManager = mm;
    ...
    public JsonNode execute(JsonNode args) throws Exception {
        ...
        agent.initialize(new com.cna.getgoat.config.CommanderConfig(), branchManager, unitsManager,
