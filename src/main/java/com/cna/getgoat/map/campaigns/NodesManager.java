...
import com.cna.getgoat.map.campaigns.node.UnitSnapshot;
import com.cna.getgoat.map.campaigns.node.UnitChange;
import com.cna.getgoat.map.campaigns.node.Movement;
...
public class NodesManager {
    ...
    private static final Logger LOG = Logger.getLogger(NodesManager.class.getName());
    ...
    public NodesManager(UnitsManager unitsManager) {
