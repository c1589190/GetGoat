...
import com.getgoat.agent.CommanderConfig;
import com.getgoat.agent.modes.IntelMode;
...
public class GenerateScenarioTool implements ToolUnit {
    ...
    public GenerateScenarioTool(MapManager mm, UnitsManager um, BranchManager bm) {
        this.mapManager = mm;
    ...
    public JsonNode execute(JsonNode args) throws Exception {
        ...
        BaseAgent intelAgent = new com.getgoat.agent.LLMCommanderAgent();
